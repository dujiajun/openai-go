...
type ChatCompletionAssistantMessageParam struct {
	...
	Reasoning        ChatCompletionAssistantMessageParamContentUnion `json:"reasoning,omitzero"`
	ReasoningContent ChatCompletionAssistantMessageParamContentUnion `json:"reasoning_content,omitzero"`
...
type ChatCompletionMessage struct {
	...
	Reasoning        string `json:"reasoning,nullable"`
	ReasoningContent string `json:"reasoningContent,nullable"`
	// The refusal message generated by the model.
	Refusal string `json:"refusal,required"`
	// The role of the author of this message.
	Role constant.Assistant `json:"role,required"`
